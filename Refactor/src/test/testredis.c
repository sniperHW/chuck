...
void chk_redis_disconnect(chk_redisclient *c,int32_t err) {
...
void redis_connect_cb(chk_redisclient *c,int32_t err,void *ud) {
	int i = 0;
...
int main() {
	...
	chk_redis_connect(loop,&server,redis_connect_cb,NULL,chk_redis_disconnect);
