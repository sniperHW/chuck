...
local log= require 'minilumen.log'
local queue3 = require 'minilumen.queue3'
...
M.new_waitd = function(waitd_table)
  ...
  if not waitd_table.tasks then 
    ...
    -- waitd_table.tasks 所有等待这个waitd的task
