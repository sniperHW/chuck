...
static inline void 
socket_set_pending_dctor(socket_ *s,void (*pending_dctor)(iorequest*))
{
...
int32_t datagram_socket_recv(dgram_socket_*,iorequest*,int32_t flag,
	                         int32_t *recvflags);

//use by subclass to construct base part
void    construct_stream_socket(stream_socket_*);
void    construct_datagram_socket(dgram_socket_*);
